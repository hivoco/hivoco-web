    ...
    <Layout>
      ...
      <section>
        <Card
          ...
          paragraph={
            "Revolutionize brand communication by turning traditional <br class='hidden xl:block' /> marketing collaterals into interactive, Multilingual Industry <br class='hidden xl:block' /> First AI-powered experiences. Designed for Indic <br class='hidden xl:block' /> Languages and with seamless voice & visual engagement, <br class='hidden xl:block' /> it goes beyond static PDFs, offering real-time updates and <br class='hidden xl:block' /> boosting customer interaction across multiple channels."
          }
          image={"talkingImg"}
